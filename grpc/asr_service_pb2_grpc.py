...
class AsrServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Recognize = channel.unary_unary(
                '/slgnm.asr.v1.AsrService/Recognize',
...
def add_AsrServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'slgnm.asr.v1.AsrService', rpc_method_handlers)
...
class AsrService(object):
    ...
    def Recognize(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/slgnm.asr.v1.AsrService/Recognize',
